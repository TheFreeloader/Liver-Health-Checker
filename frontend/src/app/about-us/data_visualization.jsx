  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.description}>
        <ul>Context:</ul>
        <p>
          Patients with Liver disease have been continuously increasing because
          of excessive consumption of alcohol, inhale of harmful gases, intake
          of contaminated food, pickles and drugs. This dataset was used to
          evaluate prediction algorithms in an effort to reduce burden on
          doctors.
        </p>
      </div>
      <div className={style.description}>
        ...
        <p>
          ...
          The "Dataset" column is a class label used to divide groups into liver
          patient (liver disease) or not (no disease). This data set contains
          441 male patient records and 142 female patient records. Any patient
          whose age exceeded 89 is listed as being of age "90".
        </p>
      </div>
      <div className={style.description}>
        <ul>Columns:</ul>
        <ul>
          ...
          <li>Dataset: field used to split the data into two sets (patient with liver disease, or no disease)</li>
        </ul>
      </div>
