...
const DataVisualization2 = () => {
  ...
  const fetchData3 = async () => {
    try {
      ...
      const formattedData = Object.entries(response.data).map(([age, frequency]) => ({
        age: parseInt(age),
        frequency: frequency,
      }));
    ...
    <div className={style.visible}>
      <div className={style.div_container}>
        ...
        >
          ...
          <h3 style={{ color: "white", textAlign: "center",fontSize:"23px" }}>AGE DISTRIBUTION</h3>
          <p style={{ color: "white", textAlign: "center", fontSize:"15px",marginTop:"1%" }}>
            This bar chart represents the frequency of different ages in the dataset.
          </p>
          <BarChart
            width={1000}
            height={600}
